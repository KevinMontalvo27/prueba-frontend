...
const VehiculosForm = ({ 
    ...
    const getTitle = () => {
        switch (mode) {
            case 'create': return 'Agregar Nuevo Vehículo';
            case 'edit': return 'Editar Vehículo';
            case 'view': return 'Ver Vehículo';
                    ...
                    {({ handleSubmit, isSubmitting, errors, touched }) => (
                        <form onSubmit={handleSubmit}>
                            <div className="form-content">
                                ...
                                <div className="input-row">
                                    <div className="input-container">
                                        <label htmlFor="clase" className="input-label">
                                            Clase
                                        </label>
                                        <Field
                                            id="clase"
                                            ...
                                            disabled={isViewMode}
                                            className={`input-field ${errors.clase && touched.clase ? 'error' : ''}`}
                                        />
                                        <ErrorMessage 
                                            name="clase" 
                                            component="span" 
                                    ...
                                    <div className="input-container">
                                        ...
                                        <Field
                                            ...
                                            name="tamanio"
                                            type="text"
                                            placeholder="Tamaño del vehículo"
                                            disabled={isViewMode}
