...
export const navesConfig = {
    title: 'Naves',
    noDataMessage: 'No existen registros',
    searchNoResultsMessage: 'No se encontraron naves para',
    ...
    formFields: [
        ...
        },
        {
            ...
            type: 'text',
            required: true,
            placeholder: 'Ingrese el modelo de la nave',
            validate: async (value) => {
                try {
                    await Yup.string()
        ...
        },
        {
            ...
            type: 'text',
            required: false,
            placeholder: 'Ingrese el tamaño de la nave',
            validate: async (value) => {
                try {
                    await Yup.string()
                        .optional()
        ...
        },
        {
            ...
            type: 'text',
            required: false,
            placeholder: 'Ingrese información del hiperimpulsor',
            validate: async (value) => {
                try {
                    await Yup.string()
                        .optional()
        ...
        },
        {
            ...
            type: 'number',
            required: false,
            placeholder: 'Ingrese el valor MGLT',
            validate: async (value) => {
                try {
                    await Yup.number()
